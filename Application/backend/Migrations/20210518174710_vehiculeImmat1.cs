    ...
    public partial class vehiculeImmat1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Seances", x => new { x.AgentId, x.CandidatId, x.DateSeance });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Convocation = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_CandidatId",
                table: "Exams",
                column: "CandidatId");

            migrationBuilder.CreateIndex(
                name: "IX_Seances_CandidatId",
                table: "Seances",
                column: "CandidatId");

            migrationBuilder.AddForeignKey(
                name: "FK_Seances_Candidates_CandidatId",
                table: "Seances",
                column: "CandidatId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Exams_Candidates_CandidatId",
                table: "Exams",
                column: "CandidatId",
                principalTable: "Candidates",
                principalColumn: "Id",
