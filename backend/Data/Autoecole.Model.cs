...
namespace backend.Data
{
    ...
    public partial class Model : DbContext
    {
        ...
        private void AgentMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Agent>().Property(x => x.Non).HasColumnName(@"Non").IsRequired().ValueGeneratedNever();
        ...
        private void LoginAgentsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LoginAgents>().Property<short>(@"AgentCIN").HasColumnName(@"AgentCIN").ValueGeneratedNever();
        ...
        private void VehicleMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vehicle>().Property<short>(@"AgentCIN").HasColumnName(@"AgentCIN").ValueGeneratedNever();
        ...
        private void SeancesMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Seances>().Property<short>(@"CandidatCIN").HasColumnName(@"CandidatCIN").ValueGeneratedNever();
            modelBuilder.Entity<Seances>().Property<short>(@"AgentCIN").HasColumnName(@"AgentCIN").ValueGeneratedNever();
        ...
        private void ExamMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Exam>().Property<short>(@"CandidatCIN").HasColumnName(@"CandidatCIN").ValueGeneratedNever();
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Agent>().HasOne(x => x.LoginAgents).WithOne(op => op.Agent).HasForeignKey(typeof(LoginAgents), @"AgentCIN").IsRequired(true);
            modelBuilder.Entity<Agent>().HasMany(x => x.Vehicles).WithOne(op => op.Agent).HasForeignKey(@"AgentCIN").IsRequired(true);
            modelBuilder.Entity<Agent>().HasMany(x => x.Seances).WithOne(op => op.Agent).HasForeignKey(@"AgentCIN").IsRequired(true);

            modelBuilder.Entity<LoginAgents>().HasOne(x => x.Agent).WithOne(op => op.LoginAgents).HasForeignKey(typeof(LoginAgents), @"AgentCIN").IsRequired(true);

            modelBuilder.Entity<Vehicle>().HasOne(x => x.Agent).WithMany(op => op.Vehicles).HasForeignKey(@"AgentCIN").IsRequired(true);
